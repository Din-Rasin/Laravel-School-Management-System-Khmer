    ...
    <div class="main-wrapper">
        <div class="header">
          <div class="header-left">
               <a href="{{ route('home') }}" class="logo" style="display: block; text-align: center;">
                <img src="{{ URL::to('#') }}"
             alt="Logo"
             style="margin: 0 auto; display: block;" />
             </a>
                  <a href="{{ route('home') }}" class="logo" style="display: block; text-align: center;">
                <img src="{{ URL::to('https://clipart-library.com/2024/school-animated-gif/school-animated-gif-2.gif') }}"
             alt="Logo"
             style="margin: 0 auto; display: block;" />
             </a>
